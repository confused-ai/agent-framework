...
export interface TypedAgent<TIn, TOut> {
     ...
     * ```
     */
    plan(goal: string): Promise<import('@confused-ai/planner').Plan>;
...
export class AgentBuilder<TIn, TOut> {
     ...
     * @example
     * ```ts
     * import { RedisMemoryStore } from '@confused-ai/memory-redis';
     *
     ...
     * @example
     * ```ts
     * import { SqliteSessionStore } from '@confused-ai/session-sqlite';
     *
