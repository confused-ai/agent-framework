...
import { runKVStoreConformance } from '@confused-ai/test-utils/conformance';
...
// ═══════════════════════════════════════════════════════════════════════════
// KVStore Conformance Suite — InMemoryStore
// ═══════════════════════════════════════════════════════════════════════════

runKVStoreConformance(() => new InMemoryStore(), { describe, it, expect });
