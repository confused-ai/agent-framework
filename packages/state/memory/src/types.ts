...
export interface VectorStoreAdapter {
     ...
     * Optional — adapters that persist data (e.g. InMemoryVectorStore) implement
     * this to enable durable `get()` on VectorMemoryStore after cache misses.
     */
    get?(id: EntityId): Promise<VectorEntry | null>;
